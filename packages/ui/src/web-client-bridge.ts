...
const webClientBridge: CcrApi = {
  ...
  exportRequestLogs: (request) => rpc("exportRequestLogs", [request]) as ReturnType<CcrApi["exportRequestLogs"]>,
  exportTextFile: (request) => rpc("exportTextFile", [request]) as ReturnType<CcrApi["exportTextFile"]>,
